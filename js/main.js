...
// Shared show-status handling, used by both the homepage spotlight and the
// Productions page grid.
const STATUS_LABELS = { live: 'Now Playing', soon: 'Coming Soon', past: 'Past Run' };

// A show counts as "past" if its Status is explicitly set to Past Run, OR if
// it has an End Date that's already gone by — whichever comes first. Shows
// with no End Date stay exactly as manually set (no auto-timeout).
